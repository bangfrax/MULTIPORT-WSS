...
curl -sS https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/nginx.conf"
rm /etc/nginx/conf.d/vps.conf
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/vps.conf"
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/multiport"
wget -O /home/vps/public_html/.htaccess "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/.htaccess"
mkdir /home/vps/public_html/ss-ws
mkdir /home/vps/public_html/clash-ws
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/issue.net"
...
# download script
cd /usr/bin
wget -O speedtest "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/speedtest_cli.py"
wget -O xp "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/xp.sh"
wget -O auto-set "https://raw.githubusercontent.com/bangfrax/MULTIPORT-WSS/main/auto-set.sh"
chmod +x speedtest
chmod +x xp
chmod +x auto-set
cd
